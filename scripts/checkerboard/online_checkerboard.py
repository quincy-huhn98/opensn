...
if __name__ == "__main__":
    ...
    absorber.CreateSimpleOneGroup(sigma_t=10, c=0.0)
    ...
    ss_solver = SteadyStateSolver(lbs_problem=phys_on)
    ss_solver.Initialize()
    ss_solver.Execute()

    phys_on.ComputeBalance()

    phys_on.WriteFluxMoments("rom")
