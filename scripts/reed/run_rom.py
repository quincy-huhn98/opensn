...
#     os.system("srun --ntasks=2 ../build/python/opensn -i offline_reed.py -p scatt={} -p id={}".format(sigma, i))

# print("Merge")
# os.system("srun --ntasks=2 ../build/python/opensn -i merge_reed.py -p id={}".format(i))

# for i, sigma in enumerate(sigmas):
#     os.system("srun --ntasks=2 ../build/python/opensn -i systems_reed.py -p scatt={} -p id={}".format(sigma,i))
...
for i, sigma in enumerate(test):
    os.system("srun --ntasks=2 ../build/python/opensn -i online_reed.py -p scatt={}".format(sigma))
    print(sigma)
