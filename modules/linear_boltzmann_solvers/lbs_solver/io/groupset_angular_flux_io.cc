...

{
  ...
  const auto file_num_gs_angles = H5ReadDataset1D<uint64_t>(file_id, "num_gs_angles");
  const auto file_num_gs_groups = H5ReadDataset1D<uint64_t>(file_id, "num_gs_groups");
